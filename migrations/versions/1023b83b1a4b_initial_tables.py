...
Revision ID: 1023b83b1a4b
Revises: 
Create Date: 2026-07-24 19:45:01.298368
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('WANT_TO_READ', 'CURRENTLY_READING', 'COMPLETED', name='readingstatus'), nullable=False),
